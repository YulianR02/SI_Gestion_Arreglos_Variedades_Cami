...
<div class="card">
    ...
    <div class="container">
      ...
      <div id="thumb" class="owl-carousel product-thumb">
        ...
        <div class="col-md-6">
          <div class="product-dtl">
            ...
            {{--<span>{{--{{$product->count_comments}}Comentarios</span> --}}
          </div>
      ...
      <div class="product-info-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link" id="review-tab" data-toggle="tab" href="#comments" role="tab" aria-controls="review" aria-selected="false">Comentarios</a>
        </li>
    </ul>

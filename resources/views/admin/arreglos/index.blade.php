...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Sección de arreglos</h3>
            ...
            <table class="table table-head-fixed">
                ...
                <tbody>
                    @foreach ($arreglos as $arreglo)
                        <tr>
                            <td scope="row">{{ $arreglo->id }}</td>
                            <td>{{ $arreglo->user->name }}</td>
                            <td>{{ $arreglo->created_at }}</td>
                            <td>{{ $arreglo->FechaEntrega }}</td>
                            <td>{{ $arreglo->EstadoArreglo }}</td>
